...
const templates: BenefitTemplate[] = [
  {
    ...
    tiers: {
      ...
      platinum: { earning_multiplier: 2.0, claims_per_year: 24, claims_per_month: 2, unlimited_claims: false, discount_percent: 20, priority_support: true, early_access: true, vip_events: true, concierge_service: true, free_shipping: true },
