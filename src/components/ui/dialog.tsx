  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed inset-0 z-50 grid w-full gap-4 border-0 bg-background p-4 shadow-lg duration-200",
        // Desktop: centered modal with max width
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:border sm:p-6",
        // Animations
